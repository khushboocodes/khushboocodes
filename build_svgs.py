...
{tspans}
  ...
  <g clip-path="url(#lc20)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="484" class="accent">- Live Activity</tspan><tspan class="cc"> -———————————————————————————————————————————-—-</tspan></text></g>
  <g clip-path="url(#lc21)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="506" class="cc">. </tspan><tspan class="value">See live GitHub activity heatmap below in README ↓</tspan></text></g>
