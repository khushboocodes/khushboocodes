...
{tspans}
  ...
  <g clip-path="url(#lc6)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="176" class="cc">. </tspan><tspan class="key">ToolChain</tspan><tspan class="cc">: ................. </tspan><tspan class="value">VS Code, Git, Docker, Postman, Vercel</tspan></text></g>
  <g clip-path="url(#lc7)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="198" class="cc">. </tspan></text></g>
  <g clip-path="url(#lc8)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="220" class="cc">. </tspan><tspan class="key">Core</tspan><tspan class="cc">.</tspan><tspan class="key">Lang</tspan><tspan class="cc">: .......... </tspan><tspan class="value">Python, TypeScript, JavaScript, C, C++</tspan></text></g>
  ...
  <g clip-path="url(#lc12)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="308" class="cc">. </tspan><tspan class="key">Core</tspan><tspan class="cc">.</tspan><tspan class="key">Infra</tspan><tspan class="cc">: ......... </tspan><tspan class="value">Docker, Vercel, Microservices, CI/CD</tspan></text></g>
  <g clip-path="url(#lc13)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="330" class="cc">. </tspan></text></g>
  <g clip-path="url(#lc14)"><text x="520" y="0" fill="{text_fill}"><tspan x="520" y="352" class="accent">- Contact</tspan><tspan class="cc"> -————————————————————————————————————————————-—-</tspan></text></g>
...
if __name__ == "__main__":
    ...
    print(f"Generated dark.svg ({len(dark_svg)} bytes) and light.svg ({len(light_svg)} bytes).")
